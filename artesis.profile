...
function artesis_form_alter(&$form, $form_state, $form_id) {
  ...
  if (defined('MAINTENANCE_MODE') && MAINTENANCE_MODE == 'install' &&
    ...
    array_walk_recursive($form, '_artesis_remove_form_requirements');
  }
}
...
function artesis_install_tasks($install_state) {
  ...
  $ret = array(
    'artesis_fetch_ding_install_tasks' =>
      array(
        'display_name' => '...',
        /**
 ...
 * fully functional.
 */
function artesis_fetch_ding_install_tasks(&$install_state) {
 ...
 */
function _artesis_remove_form_requirements(&$value, $key) {
